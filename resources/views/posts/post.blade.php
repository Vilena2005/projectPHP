    ...
    <main>
        <div class="container">
            <section class="feedbacks">
                ...
                <form action="{{ route('store') }}" method="post" class="review-form ">
                    @csrf
                    ...
                    <textarea name="feedback_text" id="feedback_text" placeholder="Введите отзыв" class="modal-form-comment"></textarea>
                    @error('feedback_text')
